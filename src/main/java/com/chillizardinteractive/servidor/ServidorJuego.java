...
public class ServidorJuego {
    ...
    private static void cicloDelJuego() {
        while (true) {
            ...
            while (true) {
                // Aquí esperamos la acción del cliente (por ejemplo, colocar carta, atacar, terminar turno)
                // Se controlará desde los mensajes que llegan al servidor desde el cliente
                try {
